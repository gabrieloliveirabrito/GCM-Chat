...
public class ChatRoomActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new ThreadAdapter(ChatRoomActivity.this, messages, AppController.getInstance().getUsID());
    ...
    private void sendMessage() {
        ...
        if (message.equalsIgnoreCase(""))
            return;
        int userId = AppController.getInstance().getUsID();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_SEND_MESSAGE,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("id", String.valueOf(AppController.getInstance().getUsID()));
